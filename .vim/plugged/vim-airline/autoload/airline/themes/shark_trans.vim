...
let s:blue     = [ 67, '#56f856']
let s:orange   = [166, '#FFFE58']
...
let g:airline#themes#shark_trans#palette = {}
let g:airline#themes#shark_trans#palette.accents = {
    \ 'red': ['#d70000', '', 160, '', '']}

let g:airline#themes#shark_trans#palette.inactive = {
    \ 'airline_a': s:IA,
    \ 'airline_b': s:IA,
    \ 'airline_c': s:IAc,
    \ 'airline_x': s:IA,
...
let g:airline#themes#shark_trans#palette.insert = {
    ...
    \ 'airline_y': s:N3,
    \ 'airline_z': s:I3}
let g:airline#themes#shark_trans#palette.insert_modified = {}
...
let g:airline#themes#shark_trans#palette.replace = {
    ...
    \ 'airline_y': s:N3,
    \ 'airline_z': s:R3}
let g:airline#themes#shark_trans#palette.replace_modified = {}
...
let g:airline#themes#shark_trans#palette.visual = {
    ...
    \ 'airline_y': s:N3,
    \ 'airline_z': s:V3}
let g:airline#themes#shark_trans#palette.visual_modified = {}

let g:airline#themes#shark_trans#palette.normal.airline_warning = s:NM1

let g:airline#themes#shark_trans#palette.normal_modified.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.insert.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.insert_modified.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.visual.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.visual_modified.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.replace.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning

let g:airline#themes#shark_trans#palette.replace_modified.airline_warning =
    \ g:airline#themes#shark_trans#palette.normal.airline_warning
