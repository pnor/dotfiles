# Generated by Powerlevel10k configuration wizard on 2020-05-16 at 12:26 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=$arrow_color
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=$failed_arrow
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$dir_name_color
  ...
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=$git_col
