...
(after! (huecycle doom-modeline hl-line company-box ewal lsp-mode)
  (huecycle-set-faces
 ;; rainbow stuff
 ((foreground . (doom-modeline-evil-normal-state
                 ...
                 doom-modeline-panel
                 doom-modeline-info lsp-face-highlight-write
 ...
 ((foreground . region)
  ...
  :random-color-luminance-range (0.5 0.8))
 ;; company popup rainbow
 ((background . (company-tooltip-selection hl-line))
  :random-color-hue-range (0.0 1.0)
